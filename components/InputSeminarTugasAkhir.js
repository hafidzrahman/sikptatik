...
export default function() {
    ...
    if (isValue) {
        content = <View>
            ...
            <View style={style.inputWrapper}>
            <Text>Kemampuan Presentasi</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Penguasaan Terhadap Materi</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Urgensi terhadap Masalah Penelitian</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Relevansi Referensi dengan Judul Penelitian</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Kesesuaian Metodologi Penelitian dengan Pembahasan</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Teknik Pengumpulan Data sesuai Standar Laporan TA</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Teknik Analisa sesuai Standar Laporan TA</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Tahapan Perancangan Sesuai Standar Laporan TA</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Produk Penelitian sesuai Standar Laporan TA</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <View style={style.inputWrapper}>
            <Text>Tahapan Pengujian Sesuai Standar Laporan TA</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Hubungan Permasalahan dengan Hasil Penelitian</Text>
            <TextInput style={style.input}/>
            </View>

...
export default function() {
    ...
    if (isValue) {
        content = <View>
            ...
            <Text>Motivasi dan Semangat</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Keuletan dalam Penelitian</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Kreativitas</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Ketepatan Waktu Penelitian sesuai Jadwal</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
            <Text>Tanggung Jawab</Text>
            <TextInput style={style.input}/>
            </View>
            <View style={style.inputWrapper}>
